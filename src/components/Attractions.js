    ...
    return (
        <>
            ...
            <div className="col" data-aos="fade-up">
                ...
                <div className="col" data-aos="fade-up">
                    <a className="text-reset" target="_blank" rel="noreferrer" href="https://www.google.co.in/maps/place/Jal+Mahal,+Amer,+Jaipur,+Rajasthan/@26.9649254,75.8339699,14z/data=!3m1!4b1!4m5!3m4!1s0x396db10189be64eb:0x9366ee1922c4a947!8m2!3d26.9656041!4d75.8592052">
                        <div className="card atimg">
                            <div className="card-body">
                ...
                <div className="col" data-aos="fade-up">
                    <a className="text-reset" target="_blank" rel="noreferrer" href="https://www.google.co.in/maps/place/Galta+Ji,+Jaipur,+Rajasthan/@26.9157175,75.8544159,15z/data=!3m1!4b1!4m5!3m4!1s0x396db72ed4ce6729:0x606059b3168da8c1!8m2!3d26.9167901!4d75.8589031">
                        <div className="card atimg">
                            <div className="card-body">
                ...
                <div className="col" data-aos="fade-up">
                    <a className="text-reset" target="_blank" rel="noreferrer" href="https://www.google.co.in/maps/place/Hawa+Mahal/@26.9239363,75.8245551,17z/data=!3m1!4b1!4m5!3m4!1s0x396db14b1bd30ba5:0x860e5d531eccb20c!8m2!3d26.9239062!4d75.8268874">
                        <div className="card atimg">
                            <div className="card-body">
